...
add address=14.14.14.2/24 interface=ether3 network=14.14.14.0
add address=192.168.1.2/24 interface=ether4 network=192.168.1.0
/ip dhcp-server network
add address=10.10.10.0/24 gateway=10.10.10.2
add address=14.14.14.0/24 gateway=14.14.14.2
/routing bgp network
add network=10.10.10.0/24
add network=14.14.14.0/24
add network=172.16.2.0/24
add network=192.168.1.0/24
/routing bgp peer
add name=peer1-ke-mkrotik2 remote-address=172.16.2.1 remote-as=65001
add name=peer2-ke-mikrotik3 remote-address=10.10.10.1 remote-as=65003
/system identity
set name="Router 1"
